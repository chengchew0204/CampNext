  ...
  return (
    <div className="min-h-screen overflow-y-auto">
      <div className="p-8 max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">WordPress Posts Debug (Español)</h1>
      
      <div className="mb-4">
        <p className="text-lg">Total de publicaciones: {posts.length}</p>
      </div>

      <div className="space-y-6">
        {posts.map((post, index) => (
          <div key={post.id} className="border rounded-lg p-4 bg-gray-50">
            <h2 className="text-xl font-semibold mb-2">Publicación {index + 1} (ID: {post.id})</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                {post.featureImage ? (
                  ...
                  <p className="text-gray-500">Sin imagen destacada</p>
                )}
              </div>
              
              <div>
                <h3 className="font-medium text-gray-700">URL del video:</h3>
                {post.videoUrl ? (
                  <div className="mt-2">
                    <video 
                      src={post.videoUrl} 
